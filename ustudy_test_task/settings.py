...
WSGI_APPLICATION = 'ustudy_test_task.wsgi.application'
...
SIMPLE_JWT = {
    ...
    'REFRESH_TOKEN_LIFETIME': timedelta(minutes=int(os.getenv('REFRESH_TOKEN_LIFETIME', 30))),
...
LOGGING = {
    ...
    'handlers': {
        'file': {
            ...
            'filename': os.path.join(BASE_DIR, 'logs/task_management.log'),
            'formatter': 'verbose',
        },
        'console': {
            'level': 'DEBUG',
